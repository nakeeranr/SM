...
namespace App\Http\Requests\SchoolAdminUser;
...
class UpdateSchoolAdminUserRequest extends BaseRequest
{
    /**
    ...
    public function __construct(SchoolAdminUser $schoolAdminUser)
    {
    ...
    {
        $schoolAdminUser = $this->schoolAdminUser->findOrFail($this->route('org_admin'));
