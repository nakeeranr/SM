               ...
               <div class="card-content">
                  <div class="card-body card-dashboard">
                     ...
                     <div class="table-responsive">
                        <table class="table zero-configuration" id="StudentsTable">
                           <thead>
                              <tr>
                                 <th>Name</th>
                                 <th>Organization</th>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>{{$Student->created_at?date('d, F Y',strtotime($Student->created_at)):''}}</td>
                                 <td class="text-center">

                                    <!-- info option -->
                                    <a href="{{ route('Students.show', [$Student->id]) }}" class="tooltip-light"  data-toggle="tooltip"  data-placement="top" data-animation="false" data-original-title="Info">
                                    ...
                                    <!-- Edit Option -->
                                    <a href="{{ route('Students.edit', [$Student->id]) }}" class="tooltip-light"  data-toggle="tooltip"  data-placement="top" data-animation="false" data-original-title="Edit">
                           ...
                           <tfoot>
                              <tr>
                                 ...
                                 <th class="font-small-2 text-uppercase">Organization</th>
