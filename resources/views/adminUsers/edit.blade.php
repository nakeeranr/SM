            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('admin-users.update',[ $adminUser->id] ) }}" method="POST" id="form-admin_user" novalidate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                'pname' => 'Male', 
                                                'val' => 0,
                                                'is_checked' => ($adminUser->gender) == 'Male' ? 'checked' : '',
                                                'is_required' => ''
                                                ])
                                                ...
                                                'pname' => 'Female', 
                                                'val' => 1,
                                                'is_checked' => ($adminUser->gender) == 'Female' ? 'checked' : '',
                                                'is_required' => ''
                                                ])
                                                ...
                                                'pname' => 'Others', 
                                                'val' => 2,
                                                'is_checked' => ($adminUser->gender) == 'Other' ? 'checked' : '',
                                                'is_required' => ''
                                                ])
                                            </ul>
