...
<!-- Mirrored from www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/ltr/vertical-menu-template/page-coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Oct 2020 19:26:10 GMT -->
<head>
    ...
    <title>Coming Soon - Frest - Bootstrap HTML admin template</title>
  ...
  <body class="vertical-layout vertical-menu-modern 1-column  navbar-sticky footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
    ...
    <div class="app-content content">
      ...
      <div class="content-wrapper">
        ...
        <div class="content-body"><!-- coming soon start -->
<section>
    <div class="row flexbox-container">
        <div class="col-md-6 col-12 text-center p-3">
            <h1 class="error-title mb-2">We are launching soon</h1>
            <p class="mb-1">Our Application is getting ready. Please register to notify you when it's ready!</p>
