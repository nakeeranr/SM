            ...
            <div class="card-header">
               <div class="heading-elements">
                  <ul class="list-inline mb-0">
                     ...
                     <!-- Back Option.End -->
                     <!-- Edit Option -->
                     <a href="{{ route('roles.edit',[$role->id]) }}" class="tooltip-light pl-0" 
                     ...
                     <div class="col-12 col-md-8">
                        <table class="table table-borderless">
                           <tbody>
                              ...
                              <tr>
                                 <td>Description:</td>
                                 <td class="users-view-username">{{$role->description??''}}</td>
                              </tr>
                              <tr>
                                 <td>Permissions:</td>
                              ...
                              <tr>
                                 <td>Status:</td>
                                 <td class="users-view-username"><span class="badge {{$role->status == 'Active'?'badge-light-success':'badge-light-danger'}} users-view-status">{{$role->status}}</span></td>
                              </tr>
                              <tr>
                                 <td>Created At:</td>
                                 <td class="users-view-role users-view-username">{{$role->created_at?date('l, jS \of F Y \@ h:i:s A',strtotime($role->created_at)):''}}</td>
                              </tr>
                              <tr>
                                 <td>Updated At:</td>
                                 <td class="users-view-role users-view-username">{{$role->updated_at?date('l, jS \of F Y \@ h:i:s A',strtotime($role->updated_at)):''}}</td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
