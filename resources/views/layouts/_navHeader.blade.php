...
@else
    ...
    <nav class="header-navbar main-header-navbar navbar-expand-lg navbar navbar-with-menu fixed-top " ata-bgcolor="bg-white" style="background-color: rgb(242, 244, 244); box-shadow: none;">
          ...
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  <div class="user-nav d-sm-flex d-none"><span class="user-name">{{ isset($sessionData['userName'])?$sessionData['userName']:'SM User'}}</span><span class="user-status text-muted">{{isset($sessionData['userRole'])?$sessionData['userRole']:'User'}}</span></div><span><img class="round" src="{{ asset('images/portrait/small/avatar-s-11.jpg') }}" alt="avatar" height="40" width="40"></span></a>
