         ...
         <div class="col-12">
            <div class="card">
               ...
               <div class="card-content">
                  <div class="card-body">
                     <form class="form form-horizontal" action="{{ route('sections.update',[$section->id]) }}" method="POST" id="form-admin_user" novalidate>
                        ...
                        <div class="form-body">
                           <div class="row">
                              ...
                              <div class="col-md-4 col-12">
                                 ...
                                 'pname' => 'Section','is_required'=>1,'val'=>$section->section_name])
                              </div>
                              <div class="col-md-4 col-12">
                                 ...
                                 <ul class="list-unstyled mb-0">
                                    ...
                                    'pname' => 'Active',
                                    'val' => 1,
                                    'is_checked' => ($section->status) == 'Active' ? 'checked' : ''
                                    ])
                                    @include('partials._formElements', [  'type' => 'radio',
                                    'field_name' => 'status',
                                    'id' => 'customRadio5',
                                    'pname' => 'Inactive',
                                    'val' => 0,
                                    'is_checked' => ($section->status) == 'Inactive' ? 'checked' : ''
                                    ])
                                 </ul>
