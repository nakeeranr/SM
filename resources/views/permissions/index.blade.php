                  ...
                  <div class="heading-elements">
                     <ul class="list-inline mb-0">
                        <a href="{{ route('permissions.create') }}">
                           <button class="btn btn-icon rounded-circle btn-success glow tooltip-light" data-toggle="tooltip"  data-placement="top" data-animation="true" data-original-title="Add Permission">
               ...
               <div class="card-content">
                  <div class="card-body card-dashboard">
                     ...
                     <div class="table-responsive">
                        <table class="table zero-configuration" id="permissionsTable">
                           <thead>
                              <tr>
                                 <th>Name</th>
                                 <th>Status</th>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>{{$permission->created_at?date('d, F Y',strtotime($permission->created_at)):''}}</td>
                                 <td class="text-center">

                                    <!-- info option -->
                                    <a href="{{ route('permissions.show',[$permission->id]) }}" class="tooltip-light"  data-toggle="tooltip"  data-placement="top" data-animation="false" data-original-title="Info">
                                    ...
                                    <!-- Edit Option -->
                                    <a href="{{ route('permissions.edit',[$permission->id]) }}" class="tooltip-light"  data-toggle="tooltip"  data-placement="top" data-animation="false" data-original-title="Edit">
